...
ทำไมต้อง Rust? เพราะมันให้ทั้งประสิทธิภาพระดับระบบ (ระดับ C/C++) ความปลอดภัยด้านหน่วยความจำโดยไม่ต้องใช้ garbage collector และรองรับการเขียนโปรแกรมแบบพร้อมกันได้อย่างปลอดภัย นี่เป็นบทที่ 1 ของซีรีส์ 8 ตอนที่จะพาคุณสร้าง WebSocket-to-TCP Proxy จริงๆ (https://github.com/bouroo/rs-wsProxy) ตั้งแต่เริ่มต้น
