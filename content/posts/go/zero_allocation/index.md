...
sync.Pool เป็นเครื่องมือที่มีประสิทธิภาพสำหรับการจัดการวัตถุชั่วคราวที่ใช้บ่อยและถูกทิ้ง มันช่วยบรรเทาค่าใช้จ่ายของการallocateและการเก็บขยะโดยการทำให้วัตถุที่นำกลับมาใช้ใหม่พร้อมใช้งาน
...
{{< /admonition >}}
#### ประโยชน์:
- ลดจำนวนการจองหน่วยความจำอย่างมีนัยสำคัญ
...
- เราหลีกเลี่ยงการจองหน่วยความจำใหม่และลดโอกาสในการ allocate จาก heap ที่เพิ่มขึ้น

### 4. การallocateแบบศูนย์สำหรับสตริง
สตริงใน Go เป็นแบบไม่เปลี่ยนแปลง หมายความว่าการแก้ไขแต่ละครั้งจะสร้างสตริงใหม่ เพื่อหลีกเลี่ยงการจองหน่วยความจำภายใต้สตริงบ่อย ๆ เราควร
- ใช้ strings.Builder สำหรับการเชื่อมต่อสตริง
- หลีกเลี่ยงการใช้ + สำหรับการเชื่อมต่อสตริงหลาย ๆ ตัวในลูป
...
หนึ่งในการเพิ่มประสิทธิภาพที่มีประสิทธิภาพที่สุดของ Go คือการวิเคราะห์โดยเทคนิคของคอมไพเลอร์ที่กำหนดว่าตัวแปรใดสามารถส่งกลับได้ใน stack หรือจำเป็นต้องฝากไว้ที่ heap
...
- ให้ความสำคัญกับ value มากกว่า pointers เมื่อขนาดของ Object ที่ return

### 6. ลดการสร้างตัวแปรซ้ำ ๆ ในแต่ละการทำงาน
ในส่วนของโค้ดที่ถูกดำเนินการบ่อย เช่น ตัวจัดการคำขอ, การวนลูป การกำจัดการจองหน่วยความจำมีผลต่อมีประสิทธิภาพตาม้พิ่มขึ้นตามจำนวนการเรียกใช้งาน
...
- เราประกาศค่า sum ไว้ล่วงหน้าแล้วนำไปใช้งานภายในลูปโดยที่ไม่ต้องประกาศตัวแปรใหม่ทุกครั้งที่มีการวนลูปช่วยให้ประหยัดเวลาของการจองหน่วยความจำได้
