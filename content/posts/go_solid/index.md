...
หมายความว่าดค้ดในแต่ละชุดควรมีความรับผิดชอบเพียงอย่างเดียวไม่ทำงานหลายอย่าง สิ่งนี้จะช่วยให้โค้ดสะอาดและบำรุงรักษาได้ง่าย เนื่องจากการเปลี่ยนแปลงโครงสร้างสามารถทำได้ในที่เดียว (ก็ใช่สิโค้ดที่ละชุดควรทำงานเฉพาะหน้าที่ของตัวเองอย่างเดียวอยู่แล้ว)
...
จะเห็นได้ว่าเมื่อทำแบบนี้แล้วไม่ว่าจะ `Tea` และ `Coffee` จะมีโครงสร้างภายในแตกต่างกันหรือเปลี่ยนไปยังไง ก็ยังคงใส่ไว้ใน `Menu` ได้ไม่กระทบกันและกันเพราะทั้งคู่ยังคงเป็น `Drinks` อยู่นั่นเอง
